...
namespace lime
{
  namespace detail
  {
    ...
    inline hid_t h5_create_timeseries_dataspace_matrix(hsize_t m, hsize_t n)    
    {
      int rank = 3;
    ...
    inline hid_t h5_timeseries_chunks_matrix(hsize_t m, hsize_t n)    
    {
      int rank = 3;
      hsize_t chunksize = 1;
    ...
    template <class coeff_t>
    inline hid_t h5_create_timeseries_dataset_matrix
    ...
    template <class coeff_t>
    inline void dump_to_hdf5_file(const Timeseries<lila::Matrix<coeff_t>>& timeseries, 
				  hid_t file_id, 
				  std::map<std::string, hid_t>& dataspace_ids,
				  std::map<std::string, hid_t>& dataset_ids, 
				  std::map<std::string, hid_t>& dataset_types, 
