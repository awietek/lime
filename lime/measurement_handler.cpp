...
namespace lime
{
  ...
  bool MeasurementHandler::defined()
  { return measurements_->defined(field_); }
  ...
  long MeasurementHandler::size() const
  { return measurements_->size(field_); }

  template <class data_t>
  void MeasurementHandler::get(long idx, data_t& data)
